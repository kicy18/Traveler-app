      ...
      p-6 lg:px-20 lg:py-10 ">
        <div className="flexCenter gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="refular-14 text-white">{subtitle}</p>
          </div>
...
const Camp = () => {
  return (
    ...
    relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20'>
      <div className='hide-scrollbar flex h-[340px] w-fu;; items-start
      justigy-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[600px]'>
        <CampSite 
